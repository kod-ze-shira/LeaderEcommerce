...
//                                     <h3 edge="end" className={classes.titleSettings}>  Title Setting of icons </h3>
//                                     <div edge="start">
//                                         <label for="ColapseLogo">
...
// export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(IconEdit));
